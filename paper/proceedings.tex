...
After identifying results with high correlation to the user's hand sizes, we applied machine learning techniques in order to predict small and big hands from the measured data.
