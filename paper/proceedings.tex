...
Finding out the user's hand size automatically might only be possible by an unnatural, artificial task. As the most promising result we got was from the radius task, this might be the right ways to investigate hand size. Our correlations as well as the classification via random forest showed that a predetermined hand position delivers a consistently higher score.\\
